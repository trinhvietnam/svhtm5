...
function getVideo(fileEntry) {
    get('./video1.mp4', function (uInt8Array) {
        console.log('111111111111111111111111111 ' + uInt8Array.length);
...
function get(url, callback) {
    ...
    xhr.setRequestHeader('Range', 'bytes=305397760-306246139');
...
function handleInitSuccess(fileSystem) {
    ...
    console.log('Initiated FileSystem: ' + fileSystem.name);
...
function writeToFile(fileEntry, blob) {
    ...
    fileEntry.createWriter(function (fileWriter) {
        fileWriter.onwriteend = function () {
            // read from file
            console.log('Wrote to file ' + fileEntry.fullPath);
